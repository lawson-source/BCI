...
columns =['Deviation',
          'matDataBComponents[1].vendor',
          'matDataBComponents[2].vendor',
          'matDataBComponents[3].vendor',
...
mins=(0.1*bad_data.shape[0]/data.shape[0])
...
rules_sort .to_csv(dirf+'/result_data/result_matDataBComponents_random.csv',index=False)
